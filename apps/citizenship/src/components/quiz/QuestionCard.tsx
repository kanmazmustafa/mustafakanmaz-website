                            ...
                            >
                                <div className="flex items-start gap-4">
                                    ...
                                    {showCorrectness && selectedOptionIndex !== undefined && (
                                        <div className="ml-auto flex-shrink-0 animate-in zoom-in duration-300">
                                            {isCorrect && <div className="text-green-600 bg-green-100 p-1 rounded-full"><span className="sr-only">Correct</span>✓</div>}
                                            {isSelected && !isCorrect && <div className="text-rose-600 bg-rose-100 p-1 rounded-full"><span className="sr-only">Incorrect</span>✗</div>}
                                        </div>
                                    )}
                                </div>
                            </div>
