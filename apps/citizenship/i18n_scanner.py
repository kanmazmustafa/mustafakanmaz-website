...
# Configuration
PROJECT_ROOT = r"c:\Users\musta\Desktop\software\android\devam_eden_projeler\einburgeringtest_app_web"
MESSAGES_DIR = os.path.join(PROJECT_ROOT, "messages")
MESSAGES_PATH = os.path.join(MESSAGES_DIR, "tr.json")
SRC_DIR = os.path.join(PROJECT_ROOT, "src")
MAIN_LOCALE = "tr"  # Primary source of truth for checking others
