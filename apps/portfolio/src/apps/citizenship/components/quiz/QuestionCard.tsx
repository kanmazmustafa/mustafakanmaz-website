...
import { ParsedQuestion } from "@/apps/citizenship/types/question";
import { Card, CardHeader, CardTitle, CardContent, CardFooter } from "@/apps/citizenship/components/ui/card";
            ...
            <Card className="w-full max-w-2xl mx-auto shadow-[0_20px_50px_-12px_rgba(0,0,0,0.15)] border-0 rounded-[2.5rem] overflow-hidden bg-white/95 backdrop-blur-sm">
                ...
                <CardFooter className="flex justify-between px-8 pb-8 bg-transparent">
                    ...
                    <Button
                        ...
                        className="bg-slate-900 hover:bg-slate-800 text-white rounded-xl px-8 shadow-lg shadow-slate-900/20 transition-all hover:scale-105 active:scale-95 hover:animate-pulse hover:ring-4 hover:ring-slate-300/50 relative z-50 cursor-pointer"
                    >
                        <span className="pointer-events-none">{isLast ? t('finish') : t('next')}</span>
                    </Button>
                </CardFooter>
            </Card>
        </motion.div>
