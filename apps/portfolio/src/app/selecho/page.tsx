...
export default function SelechoPage() {
    return (
        <main className="min-h-screen bg-background text-foreground selection:bg-blue-500/30 overflow-hidden transition-colors duration-300">
            {/* Premium Background Elements */}
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
                <div className="absolute top-[-10%] left-[-10%] w-[50%] h-[50%] bg-blue-500/10 dark:bg-blue-600/10 rounded-full blur-[120px] animate-pulse" />
                ...
                <div className="container-wide relative z-10">
                    ...
                    >
                        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-500/10 border border-blue-500/20 mb-8 backdrop-blur-md">
                            ...
                            <span className="text-xs font-mono text-blue-400 uppercase tracking-widest font-bold">Intelligent Decision Engine</span>
                        </div>

                        <h1 className="text-6xl md:text-8xl font-black tracking-tight mb-8 leading-[0.9]">
                            Selecho <br />
                            <span className="bg-clip-text text-transparent bg-gradient-to-br from-foreground via-slate-500 dark:from-white dark:via-slate-200 to-blue-500">Decisions</span>
                        </h1>

                        <p className="text-xl md:text-2xl text-slate-400 font-light leading-relaxed mb-12 max-w-2xl mx-auto">
                            A smart decision-making assistant for your daily choices.
                            Select. Compare. Decide with confidence using agentic logic.
                        </p>
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                            ...
                            <Link
                                href="/coming-soon"
                                className="group px-10 py-5 bg-blue-500/10 text-blue-400 border border-blue-500/20 rounded-2xl font-black hover:bg-blue-500/20 transition-all flex items-center gap-4 hover:scale-[1.02]"
                            >
                                ...
                                <div className="text-left">
                                    ...
                                    <div className="text-lg leading-none">Docs</div>
                                </div>
                            </Link>
                        </div>
                    </motion.div>
                    ...
                    {[
                        {
                            ...
                            desc: "Randomly select items from your custom lists. Perfect for choosing places, movies, or winners.",
                            accent: "from-blue-500 to-blue-700"
                        },
                        {
                            title: "Visual Engine",
                            desc: "Use photos from your camera or gallery to make selections more visual and intuitive.",
                            accent: "from-indigo-500 to-indigo-700"
                        },
                        {
                            title: "Privacy Core",
                            desc: "All data is stored locally on your device. Zero cloud uploads, 100% private decisions.",
                        ...
                        >
                            ...
                            <h3 className="text-2xl font-bold mb-4 text-white group-hover:text-blue-400 transition-colors uppercase tracking-tight">{feature.title}</h3>
            ...
            <section className="py-24 bg-black/5 dark:bg-white/5 border-y border-[var(--nav-border)]">
                <div className="container-wide">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-12 text-center text-white/80 uppercase tracking-widest font-mono text-[10px]">
                        <div><div className="text-4xl font-black text-white mb-2">Instant</div>Selection</div>
            ...
            <footer className="py-12 text-center text-slate-600 font-mono text-[10px] uppercase tracking-[0.4em]">
                <div className="container-wide flex flex-col md:flex-row justify-between items-center gap-6">
                    ...
                    <div className="flex gap-8">
                        <Link href="/selecho/privacy-policy" className="hover:text-white transition-colors">Privacy</Link>
