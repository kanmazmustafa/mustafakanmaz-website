                ...
                <div className="container-wide relative z-10">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
                        ...
                        <motion.div
                            ...
                            className="relative rounded-[2.5rem] overflow-hidden border border-slate-200 dark:border-white/10 bg-white dark:bg-slate-900/40 backdrop-blur-md group h-full flex flex-col hover:shadow-2xl hover:shadow-slate-200 dark:hover:shadow-amber-500/5 transition-all duration-500"
                        >
                        ...
                        <motion.div
                            ...
                            className="relative rounded-[2.5rem] overflow-hidden border border-slate-200 dark:border-white/10 bg-white dark:bg-slate-900/40 backdrop-blur-md group h-full flex flex-col hover:shadow-2xl hover:shadow-slate-200 dark:hover:shadow-indigo-500/5 transition-all duration-500"
                        >
