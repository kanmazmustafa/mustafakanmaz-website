                ...
                <div className="container-wide relative z-10">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
                        ...
                        <motion.div
                            ...
                            onClick={() => router.push(`/${locale}/einbuergerungstest`)}
                            className="relative rounded-[2.5rem] overflow-hidden border border-slate-200 dark:border-white/10 bg-white dark:bg-slate-900/40 backdrop-blur-md group h-full flex flex-col hover:shadow-2xl hover:shadow-slate-200 dark:hover:shadow-amber-500/5 transition-all duration-500 cursor-pointer"
                        >
                            <div className="absolute inset-0 bg-gradient-to-br from-amber-500/10 to-orange-600/10 dark:from-amber-500/20 dark:to-orange-600/20 opacity-30 dark:opacity-50 group-hover:opacity-100 transition-opacity duration-700" />
                        ...
                        <motion.div
                            ...
                            onClick={() => router.push(`/${locale}/ham-radio-exam-prep`)}
                            className="relative rounded-[2.5rem] overflow-hidden border border-slate-200 dark:border-white/10 bg-white dark:bg-slate-900/40 backdrop-blur-md group h-full flex flex-col hover:shadow-2xl hover:shadow-slate-200 dark:hover:shadow-indigo-500/5 transition-all duration-500 cursor-pointer"
                        >
                            <div className="absolute inset-0 bg-gradient-to-br from-indigo-500/10 to-purple-600/10 dark:from-indigo-500/20 dark:to-purple-600/20 opacity-30 dark:opacity-50 group-hover:opacity-100 transition-opacity duration-700" />
                            ...
                            {/* Ham Radio Exam prep card ends here */}
                        </motion.div>
                        ...
                        <motion.div
                            ...
                            onClick={() => router.push(`/${locale}/ccse-2026-test-nacionalidad`)}
                            className="relative rounded-[2.5rem] overflow-hidden border border-slate-200 dark:border-white/10 bg-white dark:bg-slate-900/40 backdrop-blur-md group h-full flex flex-col hover:shadow-2xl hover:shadow-slate-200 dark:hover:shadow-red-500/5 transition-all duration-500 cursor-pointer"
                        >
                            <div className="absolute inset-0 bg-gradient-to-br from-red-500/10 to-yellow-500/10 dark:from-red-500/20 dark:to-yellow-500/20 opacity-30 dark:opacity-50 group-hover:opacity-100 transition-opacity duration-700" />
                            ...
                            <div className="relative p-10 md:p-12 flex-1 flex flex-col">
                                ...
                                <div className="mt-auto">
                                    ...
                                    <div className="grid grid-cols-3 gap-3">
                                        ...
                                        <a
                                            href={`/${locale}/ccse-2026-test-nacionalidad`}
                                            onClick={(e) => e.stopPropagation()}
                                            className="px-3 py-4 bg-slate-900 dark:bg-white text-white dark:text-slate-900 rounded-xl shadow-lg shadow-slate-200 dark:shadow-white/5 transition-all flex flex-col items-center justify-center gap-1.5 group/btn"
                                        >
                                            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9" /></svg>
                        ...
                        <motion.div
                            ...
                            onClick={() => router.push(`/${locale}/selecho`)}
                            className="relative rounded-[2.5rem] overflow-hidden border border-slate-200 dark:border-white/10 bg-white dark:bg-slate-900/40 backdrop-blur-md group h-full flex flex-col hover:shadow-2xl hover:shadow-slate-200 dark:hover:shadow-blue-500/5 transition-all duration-500 cursor-pointer"
                        >
                            <div className="absolute inset-0 bg-gradient-to-br from-blue-600/10 to-indigo-600/10 dark:from-blue-600/20 dark:to-indigo-600/20 opacity-30 dark:opacity-50 group-hover:opacity-100 transition-opacity duration-700" />
