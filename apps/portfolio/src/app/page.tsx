                ...
                <div className="container-wide relative z-10">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
                        ...
                        <div className="relative group block h-full">
                            ...
                            >
                                <Link
                                    href="/chronicle-litrpg-tracker"
                                    className="absolute inset-0 z-0"
                                    aria-label="View Chronicle: LitRPG Tracker details"
                                />

                                <div className="absolute inset-0 bg-gradient-to-br from-amber-500/10 to-violet-600/10 dark:from-amber-500/20 dark:to-violet-600/20 opacity-30 dark:opacity-50 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none" />

                                <div className="relative p-10 md:p-12 flex-1 flex flex-col z-10 pointer-events-none">
                                    <div className="mb-10">
                                        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-slate-100 dark:bg-amber-500/10 border border-slate-200 dark:border-amber-500/20 mb-8">
                                            <span className="flex h-2 w-2 rounded-full bg-amber-500 animate-pulse"></span>
                                            <span className="text-[10px] font-bold text-slate-600 dark:text-amber-500 uppercase tracking-[0.2em]">LitRPG & RPG Tools</span>
                                        </div>
                                        <h2 className="text-4xl md:text-5xl font-bold text-slate-900 dark:text-white mb-6 tracking-tight">Chronicle</h2>
                                        <p className="text-slate-600 dark:text-slate-400 leading-relaxed text-base md:text-lg font-light">
                                            A sophisticated character and story management tool for the next generation of LitRPG.
                                            Real-time stat tracking and evolution history.
                                        </p>
                                    </div>
                                    ...
                                    <div className="mt-auto pointer-events-auto">
                                        <div className="h-24 mb-10 rounded-2xl bg-slate-50 dark:bg-slate-950/50 border border-slate-100 dark:border-white/5 flex items-center justify-center relative overflow-hidden">
                                            ...
                                            <div className="text-center relative z-10 flex items-center gap-10">
                                                <div>
                                                    <div className="text-2xl font-bold text-slate-950 dark:text-white mb-0.5">Beta</div>
                                                    <div className="text-[10px] text-slate-500 uppercase tracking-widest font-bold">Status</div>
                                                </div>
                                                <div className="w-px h-8 bg-slate-200 dark:bg-white/10"></div>
                                                <div>
                                                    <div className="text-2xl font-bold text-slate-950 dark:text-white mb-0.5">∞</div>
                                                    <div className="text-[10px] text-slate-500 uppercase tracking-widest font-bold">Evolution</div>
                                                </div>
                                            </div>
                                        </div>
